...
public class RegisterPage extends Utility {
    ...
    public void dateOfBirthMonth(String month) {
        log.info("Enter month for date of birth." + month + "in month field" + monthOfBirthDay.toString());

        selectByVisibleTextFromDropDown(monthOfBirthDay, month);
    }

    public void dateOfBirthYear(String year) {
        log.info("Enter year for date of birth." + year + "in year field" + yearOfBirthDay.toString());
